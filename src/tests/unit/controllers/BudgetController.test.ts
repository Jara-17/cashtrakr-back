...
describe("BudgetController.create", () => {
  it("Should create a new budget and respond with statusCode 201", async () => {
    ...
    (Budget.create as jest.Mock).mockReturnValue(mockBudget);

    const req = createRequest({
      method: "POST",
      url: "/api/budgets",
      body: { name: "Presupuesto Prueba", amount: 500 },
      user: { id: 1 },
    });
...
describe("BudgetController.getById", () => {
  ...
  it("Should retrieve a budget by ID 1 and 3 expenses", async () => {
    const req = createRequest({
      method: "GET",
  ...
  it("Should retrieve a budget by ID 2 and 2 expenses", async () => {
    const req = createRequest({
      method: "GET",
      url: "/api/budgets/:budgetId",
      budget: { id: 2 },
  ...
  it("Should retrieve a budget by ID 3 and 0 expenses", async () => {
    const req = createRequest({
      method: "GET",
      url: "/api/budgets/:budgetId",
      budget: { id: 3 },
...
describe("BudgetController.updateById", () => {
  it("should update the budget and return a success message", async () => {
    ...
    const req = createRequest({
      ...
      url: "/api/budgets/:budgetId",
      budget: budgetMock,
      body: { name: "Presupuesto Actualizado!", amount: 600 },
    });
